...
import { Users, TrendingUp, DollarSign, Target, Clock, Activity } from "lucide-react";
...
const Manager = () => {
  ...
  const kpis = [
    ...
    { label: "Team Close Rate", value: stats ? `${Math.round((Number(stats.active_reps) / Math.max(Number(stats.total_leads), 1)) * 100)}%` : "—", icon: TrendingUp, color: "text-green-400" },
  ];
